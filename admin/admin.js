...
var MODULOS = {
  ...
  profesionales: {
    ...
    campos: [
      { c: "nombre", t: "Nombre", req: true },
      { c: "categoria", t: "Oficio", tipo: "select", ops: CATEGORIAS_PRO, req: true, mitad: true },
      { c: "telefono", t: "Teléfono", mitad: true },
      { c: "email", t: "Email", tipo: "email", mitad: true },
...
var ORDEN_MENU = [
  ...
  { sep: "Economía", items: ["costes", "ingresos", "contabilidad"] },
...
function modal(titulo, cuerpo, pie) {
  $("#modal-host").innerHTML =
    '<div class="modal" id="modal"><div class="modal__caja">' +
    ...
    .then(function (res) {
      ...
      obras.forEach(function (o) {
        ...
        h += "<tr><td><b>" + esc(o.titulo) + "</b>" +
             ...
             '<td><button class="btn btn--sm btn--fant" data-equipo="' + o.id + '">' + o.n_profesionales + " asignados</button></td>" +
